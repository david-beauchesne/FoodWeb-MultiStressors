# source('./code/figures/FR4-Density_boxplot.R')
library(tidyverse)
...
pdf('./Figures/Figure_4.pdf', width = 7.87, height = 10.51, pointsize = 12)
...
mtext(text = TeX('\\textbf{Trophic sensitivity} ($\\textit{S_{i,G}}$)'), side = 1, line = 2.75, cex = 1.25)
...
mtext(text = TeX('\\textbf{Trophic sensitivity} ($\\textit{S_{i,G}}$)'), side = 2, line = 2.75, cex = 1.25)
