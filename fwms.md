...
Stressors may also combine to strengten or weaken their respective impacts. For instance, fisheries weaken the impact of climate stressors on shrimp when combined, although it greatly increases trophic amplification (Figure \ref{species}). These observations stress the a species sensitivity to and amplification of multiple stressors will be context dependent and thus cannot be properly evaluated without holistically considering its context.
